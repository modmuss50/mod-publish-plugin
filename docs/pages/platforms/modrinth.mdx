  ...
  <Tab>
    ...
    publishMods {
        modrinth {
            ...
            // Optionally set the Modrinth environment for the uploaded version
            ...
            // Upload an additional file and tell Modrinth what type it is
...
The `environment` option can be left unset. When set, it accepts one of the following values:
...
The `type` of an `additionalFile` can be one of the following values:
